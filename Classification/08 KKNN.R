...
for(kn1 in kns) {
  ...
  for (g in 1:kf) {
    ...
    modtr = kknn::kknn(as.factor(y) ~ . , 
                     train = auxtr, test = auxtr, 
                     k = kn1, scale = FALSE,
                     kernel = "rectangular", distance = 2)
    
    modte = kknn::kknn(as.factor(y) ~ . , 
                     train = auxtr, test = auxte, 
                     k = kn1, scale = FALSE,
                     kernel = "rectangular", distance = 2)
